---
title: Prototype-Conditioned Koopman ECG Classifier
tags:
  - ECG
  - Koopman
  - APT
...
## 3. 为什么不能只是 APT + Koopman 简单拼接？

简单拼接是：

\[
ECG \rightarrow APT \rightarrow Koopman \rightarrow Classifier
\]
...
\[
\alpha_{t,i} =
\frac{\exp(\text{sim}(z_{n,t}, p_i))}
{\sum_j \exp(\text{sim}(z_{n,t}, p_j))}
\]
...
\[
\boxed{
z_n \rightarrow \alpha \rightarrow K_\alpha,\quad
K_\alpha z_p \rightarrow \hat{z}_{p,t+1}
}
\]
