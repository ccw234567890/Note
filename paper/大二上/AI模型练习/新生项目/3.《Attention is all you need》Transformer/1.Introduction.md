...
*   **知识点 (Knowledge Points):**
    *   [[paper/大二上/AI模型练习/新生项目/3.《Attention is all you need》Transformer/Recurrent Neural Networks (RNN)]]: 一类为处理序列数据而设计的神经网络，其核心特征是拥有循环连接。 #AI/DeepLearning/Models
...
*   **知识点 (Knowledge Points):**
    *   [[paper/大二上/AI模型练习/新生项目/3.《Attention is all you need》Transformer/Hidden State]]: RNN中用于存储过去信息的内部记忆单元。 #AI/DeepLearning/Fundamentals
