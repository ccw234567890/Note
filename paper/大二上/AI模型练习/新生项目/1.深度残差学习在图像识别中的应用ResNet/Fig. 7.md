...
>
> 这有力地支持了 ResNet 的核心设计思想：[[paper/大二上/AI模型练习/新生项目/1.深度残差学习在图像识别中的应用ResNet/解析：ResNet为何能轻松学习恒等映射|为优化器提供一个捷径]]，让它在[[paper/大二上/AI模型练习/新生项目/1.深度残差学习在图像识别中的应用ResNet/恒等映射]]的基础上进行微调，而不是从零开始学习一个全新的函数。
...
2.  **证实了“预处理”的有效性**:
    - ResNet 的快捷连接结构为优化问题提供了一个极佳的“预处理”，即默认基准是[[paper/大二上/AI模型练习/新生项目/1.深度残差学习在图像识别中的应用ResNet/恒等映射]]。
...
- [[残差网络 (ResNet)]]
- [[残差块 (Residual Block)]]
- [[paper/大二上/AI模型练习/新生项目/1.深度残差学习在图像识别中的应用ResNet/响应值]]
- [[paper/大二上/AI模型练习/新生项目/1.深度残差学习在图像识别中的应用ResNet/恒等映射]]
- [[paper/大二上/AI模型练习/新生项目/1.深度残差学习在图像识别中的应用ResNet/解析：ResNet为何能轻松学习恒等映射]]
