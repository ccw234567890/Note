...
- **原因**: 这并非由[[过拟合]]导致，而是因为非常深的网络**极难优化**。梯度在多层非线性变换中传播时，容易出现[[梯度消失]]或[[梯度爆炸]]，导致网络难以学习到一个有效的函数，甚至连一个简单的**[[paper/大二上/AI模型练习/新生项目/1.深度残差学习在图像识别中的应用ResNet/解析：ResNet为何能轻松学习恒等映射]] (Identity Mapping)** 都学不会。
