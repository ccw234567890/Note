...
*   **知识点 (Knowledge Points):**
    *   [[paper/大二上/Week Ⅰ/3.《Attention is all you need》Transformer/Sequence Transduction]]: 再次强调这是本文及相关工作试图解决的核心问题。 #AI/DeepLearning/Fundamentals
    *   `[[Extended Neural GPU]]`: 一种早期的、试图通过类似RNN的循环机制和卷积操作来增强并行性的序列模型。 #AI/DeepLearning/Models
    *   [[paper/大二上/Week Ⅰ/3.《Attention is all you need》Transformer/ByteNet]]: 一种用于机器翻译的深度一维卷积网络，使用空洞卷积来扩大感受野。 #AI/DeepLearning/Models
...
*   **知识点 (Knowledge Points):**
    *   [[paper/大二上/Week Ⅰ/3.《Attention is all you need》Transformer/Computational Path Length]]: Transformer的核心优势之一，其自注意力机制使得任意两个位置之间的计算路径长度都是常数O(1)。 #AI/NLP/Architecture
...
*   **知识点 (Knowledge Points):**
    *   [[paper/大二上/Week Ⅰ/3.《Attention is all you need》Transformer/Self-Attention]]: 正式定义了自注意力。它与传统的Encoder-Decoder注意力（关联两个不同序列）不同，它是在单个序列内部进行关联。 #AI/NLP/Mechanisms
