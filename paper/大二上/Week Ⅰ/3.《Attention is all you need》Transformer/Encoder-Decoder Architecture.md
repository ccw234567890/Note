...
> [!quote] 核心论述
> **[[paper/大二上/Week Ⅰ/3.《Attention is all you need》Transformer/Encoder-Decoder Architecture]]**: [[paper/大二上/Week Ⅰ/3.《Attention is all you need》Transformer/Sequence Transduction|序列到序列]]任务的标准框架，编码器负责理解输入序列，解码器负责生成输出序列。
...
- **过程**:
    - 通常由一个[[paper/大二上/Week Ⅰ/3.《Attention is all you need》Transformer/Recurrent Neural Networks (RNN)|RNN]]（或 LSTM, GRU）实现。
