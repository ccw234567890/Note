...
- **知识点 (Knowledge Points):**
    ...
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/VLAD (Vector of Locally Aggregated Descriptors)]]: 一种在图像检索和分类中常用的特征编码和聚合方法，其核心是计算局部特征与聚类中心（字典）的残差。 #AI/ComputerVision/FeatureEncoding
        
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Fisher Vector]]: 另一种强大的特征编码方法，从生成模型的角度出发，通过梯度来表示数据，可以被视为VLAD的推广。 #AI/ComputerVision/FeatureEncoding
...
- **知识点 (Knowledge Points):**
    ...
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/浅层表示 (Shallow Representation)]]: 指与深度学习模型的多层级、端到端学习的特征相对立的、通常需要手动设计或仅有少数几层处理的特征表示。 #AI/Terminology/General
...
- **知识点 (Knowledge Points):**
    ...
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Multigrid Method]]: 一种求解偏微分方程的高效数值算法，其核心思想是在不同分辨率的网格上迭代求解，并在粗网格上计算和修正细网格解的残差。 #Science/NumericalMethods/Solvers
...
- **知识点 (Knowledge Points):**
    ...
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Convergence Rate]]: 衡量迭代算法接近最终解速度的指标。 #Science/NumericalMethods/Evaluation
...
- **知识点 (Knowledge Points):**
    ...
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Auxiliary Classifier]]: 在网络中部添加的小型分类器，用于在训练时提供额外的梯度，以缓解梯度消失。 #AI/DeepLearning/Techniques
...
- **知识点 (Knowledge Points):**
    ...
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Inception Module]]: GoogLeNet的核心构建块，通过并行使用不同尺寸的卷积核和快捷连接来捕捉多尺度特征。 #AI/DeepLearning/Architecture
...
- **知识点 (Knowledge Points):**
    ...
    - [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Highway Networks]]: 一种引入了类似LSTM门控机制的深度前馈网络，允许信息无障碍地“高速”通过多层网络。 #AI/DeepLearning/Models
