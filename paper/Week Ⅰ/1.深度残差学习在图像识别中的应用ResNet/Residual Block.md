...
> [!quote] 核心论述
> [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Residual Block]]: 暗示了残差学习是以“块”（block）为单位在网络中应用的，而不是应用到每一层。
...
- **快捷连接**: 是一条纯粹的**[[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/恒等映射]]**通路，不进行任何操作，直接将输入 $x$ 传递过去。
...
- [[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/全零映射]]
- [[Batch Normalization]]