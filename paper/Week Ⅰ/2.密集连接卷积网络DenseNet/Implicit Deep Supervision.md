...
- **实现方式**: 在 [[GoogLeNet]] 中，研究者在网络的中间层旁边，**额外**搭建了几个小型的**[[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Auxiliary Classifier|辅助分类器]]**。
...
| :--- | :--- | :--- |
| **机制来源** | **额外添加**的[[paper/Week Ⅰ/1.深度残差学习在图像识别中的应用ResNet/Auxiliary Classifier\|辅助分类器]] | 网络**自身结构**（密集连接）的内在属性 |
