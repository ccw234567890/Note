...
> [!quote] 核心论述
> **[[paper/Week Ⅰ/3.《Attention is all you need》Transformer/Attention Mechanism]]**: 一种允许模型在生成输出时，动态地将注意力聚焦于输入序列不同部分的技术，极大地提升了序列到序列模型的性能。

---

## 1. 核心问题：[[paper/Week Ⅰ/3.《Attention is all you need》Transformer/Encoder-Decoder Architecture|编码器-解码器]]的“信息瓶颈”

在注意力机制出现之前，标准的 [[paper/Week Ⅰ/3.《Attention is all you need》Transformer/Encoder-Decoder Architecture|编码器-解码器]] 架构存在一个致命弱点：
...
> 如果我们有办法让序列中的任意两个位置直接交互（通过注意力），我们还需要[[paper/Week Ⅰ/3.《Attention is all you need》Transformer/Recurrent Neural Networks (RNN)|RNN]]那种必须按顺序一步步处理的“循环”结构吗？
