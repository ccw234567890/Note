...
> *[[paper/Week Ⅰ/3.《Attention is all you need》Transformer/Continuous Representation]]: 也叫向量嵌入（Vector Embedding），是将离散符号（如单词）映射到低维连续向量空间的技术。*
...
## 关联概念
- [[paper/Week Ⅰ/3.《Attention is all you need》Transformer/Encoder-Decoder Architecture]]
